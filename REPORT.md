...
**（async 臂,median;完整表見 [overall_results.md](overall_results.md)。`open`=冷 open(db)、`deliver`=prefetch syscalls;`e2e_std`=fq+open+deliver、`e2e_warm`=fq+deliver。）**
...
(完整數字見 §5 / [overall_results.md](overall_results.md)):first-query
