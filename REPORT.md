...
robustness 驗證；§7 discussion 與實務建議；§8 related work；§9 future work；
§10 conclusion。
...
### 8.2 Database buffer pool warming
...
### 8.3 SQLite / mobile / embedded DB optimization
...
### 8.4 SSD / NVMe page-aware optimization
...
### 8.5 Memory-mapped DB & mincore-based introspection
...
| FEMU | https://github.com/MoatLab/FEMU | Future Work §9 提到的 SSD-level evaluation 平台 |
